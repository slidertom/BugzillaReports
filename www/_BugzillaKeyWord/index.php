...
class CGenerateBugzillaPage extends CGeneratePage
{
    ...
    protected function GenerateHeadData() 
    {
        ...
        echo "<link rel='stylesheet' type='text/css' href='../_Bugzilla/gantt/css/style.css' />\n";
    ...
    { 
        ...
        echo "<script type='text/javascript' src='../_Bugzilla/gantt/js/jquery.fn.gantt.js'></script>\n";
        // opentip
